        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            <tr>
              ...
              $buscar = $pdo->prepare("SELECT a.id, a.id_autor, a.titulo, a.publicacion, r.nombre FROM articulos a INNER JOIN registros r ON a.id_autor = r.id;");
              $buscar->execute();
              ...
              foreach ($res as $single) {
                echo '
                  <th scope="row">' . $single["titulo"] . '</th>
                    <td><a href="http://localhost:8888/2025/clase/blog/autor.php?id_autor=' . $single["id_autor"] . '">' . 
                      $single["nombre"] 
                    . '</a></td>
                    <td>' . $single["publicacion"] . '</td>
                    <td class="text-center align-middle">
                      <a href="http://localhost:8888/2025/clase/blog/editar.php?id_articulo=' . $single["id"] . '">
                        <i class="bi bi-pencil-fill p-2"></i>
                      </a>
                       <a href="http://localhost:8888/2025/clase/blog/eliminar.php?id_articulo=' . $single["id"] . '">
